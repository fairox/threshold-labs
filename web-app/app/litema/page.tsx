...
export default function LitemaPage() {
    return (
        <main className="min-h-screen bg-neutral-100 text-neutral-900 font-sans selection:bg-black selection:text-white">
            <Header />
            ...
            <section className="py-24 border-t border-neutral-200">
                <SwissGrid>
                    ...
                    <SwissColumn span="col-span-full">
                        <Link href="/litema/read" className="group block">
